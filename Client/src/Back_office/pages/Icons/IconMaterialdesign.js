...
class IconMaterialdesign extends Component {
  constructor(props) {
    super(props)
    this.state = {}
  }
  ...
  render() {
    return (
      <React.Fragment>
        ...
        <MetaTags>
            <title>Material Design | Skote - Responsive Bootstrap 5 Admin Dashboard</title>
          </MetaTags>
          <Container fluid>
                ...
                <Card>
                  <CardBody>
                    ...
                    <p className="card-title-desc mb-2">
                      ...
                      <span className="badge bg-success">v 5.8.55</span>.
                    </p>
