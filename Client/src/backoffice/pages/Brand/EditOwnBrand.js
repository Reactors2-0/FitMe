...
const EditBrand = () => {
    ...
    const { loading, brandByUserId, error, success } = brandByUserIdSelector;
    ...
    useEffect(() => {
        if (success) {
            setName(brandByUserId.brandName);
            setImage(brandByUserId.brandImage);
            setProof(brandByUserId.brandProof);
        }
    }, [dispatch, success]);
    const submitHandler = (e) => {
        ...
        brandByUserId.name = name;
        brandByUserId.brandImage = image;
        brandByUserId.brandProof = proof;
